...
* [pyenv](https://github.com/yyuu/pyenv) - Simple Python version management. (py2,py3)
...
* [virtualenv-api](https://github.com/sjkingo/virtualenv-api) - An API for virtualenv and pip. (py2)
...
* [PyRun](https://www.egenix.com/products/python/PyRun/) - A one-file, no-installation-needed version of Python. (py2, py3)
